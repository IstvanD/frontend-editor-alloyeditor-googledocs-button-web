...
package com.liferay.frontend.editor.alloyeditor.googledocs.button.web.editor.configuration;
 ...
 */
@Component(
	property = {"editor.name=alloyeditor", "service.ranking:Integer=100"},
	service = EditorConfigContributor.class
)
public class AlloyEditorGoogleDocsButtonConfigContributor
